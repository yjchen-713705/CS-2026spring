...
HD_PWD='D:/sgh/ALU_4bit/ALU_4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log add_sub_4bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source add_sub_4bit.tcl
